...
public class Recursion {
    ...
    // sum(new int []{1,2,3,4}) == 10 EXAM STUDY
    ...
    // Arrays.equals(new int [] {1,2,3,4}, EXAM STUDY
    //               new int [] {4,3,2,1})
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(isPalindrome(("go hang a salami im a lasagna hog").equals("go hang a salami im a lasagna hog"));
...
//ignore binary numbers on the exam!
